...
export default function DevSettingsPanel() {
  ...
  return (
    <>
      ...
      >
        <div className="font-semibold mb-1 text-gray-800">Active API Calls:</div>
        <div className="space-y-0.5 text-left">
          <div className="flex items-center gap-1.5">
            <span className={`w-1.5 h-1.5 rounded-full ${settings.enableDeepgram ? 'bg-green-500' : 'bg-gray-400'}`}></span>
            <span>Deepgram: {settings.enableDeepgram ? 'Enabled' : 'Disabled'}</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className={`w-1.5 h-1.5 rounded-full ${settings.enableClaude ? 'bg-green-500' : 'bg-gray-400'}`}></span>
            <span>Claude: {settings.enableClaude ? 'Enabled' : 'Disabled'}</span>
          </div>
        </div>
      </button>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg">
                <p className="text-sm text-yellow-800">
                  <strong>Dev Mode Active</strong> - These settings control API calls during testing.
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Active API Calls:</h4>
